...
// I'm reusing the code from the blocky world assignment here.
...
var VSHADER_SOURCE =`
  ...
  void main() {
  mat4 worldMatrix = u_GlobalRotation * u_ModelMatrix;
...
function addUiEvents() {
  ...
  var normals = document.getElementById('toggleNormals');
  if (normals) {
    normals.addEventListener('click', function() {
...
function renderScene() {
  ...
  gl.uniform3f(u_ViewPos, camera.eye.elements[0], camera.eye.elements[1], camera.eye.elements[2]);
  ...
  lightCube.textureNum = 0;
  lightCube.texWeight = 0.5;
...
function updateLight() {
  ...
  var rad = (baseAngle + orbit) * Math.PI / 180.0;
